...
const search = kit.curry(
  (namespace, key, data) =>
    kit.search(makeNamespacePath(namespace, key), data)
);


// additional exports should be added here:
const customExports = { publicKey, publicNamespace, makeNamespacePath, search };
...
/**
 * Validates the Session Annotation Object against the json schema
 *
 * @function
 * @param {object} source The Session Annotation Object
 * @returns {boolean}
 */

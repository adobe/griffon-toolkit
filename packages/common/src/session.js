 ...
 */
const path = {
  /** Array of SessionAnnotation objects.<br />Path is `a.n.n.o.t.a.t.i.o.n.s`. */
  annotations: 'a.n.n.o.t.a.t.i.o.n.s',

  /** The base url of the application connected to this session.<br />Path is `l.i.n.k`. */
  link: 'l.i.n.k',

  /** The first name of the user who created the session.<br />Path is `f.i.r.s.t.N.a.m.e`. */
  firstName: 'f.i.r.s.t.N.a.m.e',

  /** The last name of the user who created the session.<br />Path is `l.a.s.t.N.a.m.e`. */
  lastName: 'l.a.s.t.N.a.m.e',

  /** The name of the session.<br />Path is `n.a.m.e`. */
  name: 'n.a.m.e',

  /** Uniquely identifies each session.<br />Path is `u.u.i.d`. */
  sessionId: 'u.u.i.d'
};

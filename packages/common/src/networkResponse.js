...
var networkResponse_json_1 = __importDefault(require("../schemas/networkResponse.json"));
/**
 ...
 * @returns {boolean}
 */
var getFromCache = kit.search(path.fromCache);
/**
 ...
 * @returns {object}
 */
var getResponseHeaders = kit.search(path.responseHeaders);
/**
 ...
 * @returns {*}
 */
var getResponseHeadersKey = kit.curry(function (searchPath, source) { return kit.search(path.responseHeaders + "." + searchPath, source); });
/**
 ...
 * @returns {number}
 */
var getStatusCode = kit.search(path.statusCode);
/**
 ...
 * @returns {string}
 */
var getStatusLine = kit.search(path.statusLine);
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ rootType: 'netres' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ fromCache: false, initiator: 'http://test.demo.com', ip: '50.51.52.53', domain: 'demo.com', host: 'alt.demo.com', hostname: 'alt.demo.com', origin: 'http://alt.demo.com', path: '/path/to/demo', protocol: 'https', query: 'mode=details', method: 'GET', responseHeaders: { 'Content-Type': 'image/png' }, requestId: 'abcdefg', statusCode: 200, statusLine: 'HTTP/1.1 200 OK', url: 'http://alt.demo.com/path/to/demo?mode=details', rootType: 'netres', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: networkResponse_json_1["default"], get: get }, customExports), { getFromCache: getFromCache, getInitiator: getInitiator, getIp: getIp, getLocation: getLocation, getLocationKey: getLocationKey, getDomain: getDomain, getHash: getHash, getHost: getHost, getHostname: getHostname, getOrigin: getOrigin, getPath: getPath, getPort: getPort, getProtocol: getProtocol, getQuery: getQuery, getMethod: getMethod, getResponseHeaders: getResponseHeaders, getResponseHeadersKey: getResponseHeadersKey, getRequestId: getRequestId, getStatusCode: getStatusCode, getStatusLine: getStatusLine, getUrl: getUrl, getRootType: getRootType, isMatch: isMatch, matcher: matcher, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

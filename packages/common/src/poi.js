 ...
 */
const path = {
  /** The POI latitude.<br />Path is `l.a.t.i.t.u.d.e`. */
  latitude: 'l.a.t.i.t.u.d.e',

  /** The Places library the POI belongs to.<br />Path is `l.i.b.r.a.r.y.i.d`. */
  libraryId: 'l.i.b.r.a.r.y.i.d',

  /** The POI longitude.<br />Path is `l.o.n.g.i.t.u.d.e`. */
  longitude: 'l.o.n.g.i.t.u.d.e',

  /** The POI name.<br />Path is `r.e.g.i.o.n.n.a.m.e`. */
  name: 'r.e.g.i.o.n.n.a.m.e',

  /** An object with some defined items and custom data items..<br />Path is `r.e.g.i.o.n.m.e.t.a.d.a.t.a`. */
  metadata: 'r.e.g.i.o.n.m.e.t.a.d.a.t.a',

  /** The POI category.<br />Path is `r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".c.a.t.e.g.o.r.y`. */
  category: 'r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".c.a.t.e.g.o.r.y',

  /** The POI city.<br />Path is `r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".c.i.t.y`. */
  city: 'r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".c.i.t.y',

  /** The POI country.<br />Path is `r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".c.o.u.n.t.r.y`. */
  country: 'r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".c.o.u.n.t.r.y',

  /** The POI state.<br />Path is `r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".s.t.a.t.e`. */
  state: 'r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".s.t.a.t.e',

  /** The POI street.<br />Path is `r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".s.t.r.e.e.t`. */
  street: 'r.e.g.i.o.n.m.e.t.a.d.a.t.a.".".s.t.r.e.e.t',

  /** The POI radius.<br />Path is `r.a.d.i.u.s`. */
  radius: 'r.a.d.i.u.s',

  /** The unique region id.<br />Path is `r.e.g.i.o.n.i.d`. */
  id: 'r.e.g.i.o.n.i.d',

  /** Is the user currently in the POI.<br />Path is `u.s.e.r.i.s.w.i.t.h.i.n`. */
  within: 'u.s.e.r.i.s.w.i.t.h.i.n',

  /** The weight of the POI. It is used to prioritze POIs when a user is inside multile POIS.<br />Path is `w.e.i.g.h.t`. */
  weight: 'w.e.i.g.h.t'
};

...
var logEvent_json_1 = __importDefault(require("../schemas/logEvent.json"));
/**
 ...
 * @returns {string}
 */
var getLogLine = kit.search(path.logLine);
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ rootType: 'log' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ logLine: '07-16 11:28:56.116 20544:20583 V/AdobeExperienceSDK ]↵EventHub(AMSEventHub) - Registering extension', rootType: 'log', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: logEvent_json_1["default"], get: get }, customExports), { getLogLine: getLogLine, isMatch: isMatch, matcher: matcher, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

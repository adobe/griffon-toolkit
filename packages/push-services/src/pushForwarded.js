...
var pushForwarded_json_1 = __importDefault(require("../schemas/pushForwarded.json"));
/**
 ...
 */
var label = 'Push Request Forwarded';
/**
 ...
 * @constant
 */
var EVENT_NAME = 'push sent to platform service';
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventName: 'push sent to platform service', rootType: 'Push Service', vendor: 'com.adobe.cepheus' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ eventName: 'push sent to platform service', groupId: 'the-group-id', platform: 'fcmV1', pushToken: 'asdfasdf-asdfasdf-asdfasdf', body: '{ "name": "mymessage" }', status: 200, rootType: 'Push Service', vendor: 'com.adobe.cepheus', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: pushForwarded_json_1["default"], get: get }, customExports), { getEventName: getEventName, getGroupId: getGroupId, getPlatform: getPlatform, getPushToken: getPushToken, getBody: getBody, getStatus: getStatus, isMatch: isMatch, matcher: matcher, EVENT_NAME: EVENT_NAME, ROOT_TYPE: ROOT_TYPE, VENDOR: VENDOR, label: label, group: group, parentDepth: parentDepth });

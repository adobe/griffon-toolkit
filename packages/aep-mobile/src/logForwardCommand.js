...
import schema from '../schemas/logForwardCommand.json';
...
const path = {
  ...
  /** Turn on or off the log forwarding.<br />Path is `p.a.y.l.o.a.d.".".d.e.t.a.i.l.".".e.n.a.b.l.e`. */
  enable: 'p.a.y.l.o.a.d.".".d.e.t.a.i.l.".".e.n.a.b.l.e',
 ...
 * @returns {boolean}
 */
const getEnable = kit.search(path.enable);
...
const matcher = kit.combineAll([
  'p.a.y.l.o.a.d.".".t.y.p.e==\'logForwarding\'',

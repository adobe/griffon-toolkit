...
var logForwardCommand_json_1 = __importDefault(require("../schemas/logForwardCommand.json"));
/**
...
var path = {
    ...
    /** Turn on or off the log forwarding.<br />Path is `payload.detail.enable`. */
    enable: 'payload.detail.enable',
...
/**
 * Returns the `type` from the Log Forward Command.
 * This is the the type of command.
 *
 * Path is `payload,type`.
 *
 * @function
 * @param {object} source The Log Forward Command instance
 * @returns {string}
 */
var getType = kit.search(path.type);
/**
 * Returns the `detail` from the Log Forward Command.
...
/**
 * Returns the `enable` from the Log Forward Command.
 * This is the turn on or off the log forwarding.
 *
 ...
 * @returns {boolean}
 */
var getEnable = kit.search(path.enable);
/**
...
/**
 * Generates a Log Forward Command with the const values set.
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ type: 'logForwarding', vendor: 'com.adobe.griffon.mobile', rootType: 'control' }, input)); };
/**
 * Generates a Log Forward Command with some default values set.
 * Can be useful in testing.
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ type: 'logForwarding', enable: true, vendor: 'com.adobe.griffon.mobile', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootType: 'control' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: logForwardCommand_json_1["default"], get: get }, customExports), { getType: getType, getDetail: getDetail, getDetailKey: getDetailKey, getEnable: getEnable, isMatch: isMatch, matcher: matcher, TYPE: TYPE, VENDOR: VENDOR, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

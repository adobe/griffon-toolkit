...
var mediaSessionCreated_json_1 = __importDefault(require("../schemas/mediaSessionCreated.json"));
/**
 ...
 */
var label = 'Media Session Created Event';
/**
 ...
 * @constant
 */
var EVENT_SOURCE = 'com.adobe.eventsource.media.sessioncreated';
/**
 ...
 * @returns {string}
 */
var getMediaServiceSessionId = kit.search(path.mediaServiceSessionId);
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.eventsource.media.sessioncreated', eventType: 'com.adobe.eventtype.media', rootType: 'generic' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ mediaServiceSessionId: 'mediaserviceSessionid123', sessionId: 'sessionid123', eventSource: 'com.adobe.eventsource.media.sessioncreated', eventType: 'com.adobe.eventtype.media', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: mediaSessionCreated_json_1["default"], get: get }, customExports), { getMediaServiceSessionId: getMediaServiceSessionId, getSessionId: getSessionId, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

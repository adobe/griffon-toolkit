...
import schema from '../schemas/propositionResponse.json';
...
const path = {
  ...
  /** The XDM data send to the server.<br />Path is `payload.ACPExtensionEventData.propositions`. */
...
/**
 * Returns the `propositions` from the Update Proposition.

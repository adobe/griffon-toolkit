...
var analyticsResponse_json_1 = __importDefault(require("../schemas/analyticsResponse.json"));
/**
 ...
 * @constant
 */
var EVENT_TYPE = 'com.adobe.eventtype.analytics';
/**
 ...
 * @returns {string}
 */
var getRequestEventId = kit.search(path.requestEventId);
/**
 ...
 * @returns {string}
 */
var getHitUrl = kit.search(path.hitUrl);
/**
 ...
 * @returns {object}
 */
var getHitHeaders = kit.search(path.hitHeaders);
/**
 ...
 * @returns {*}
 */
var getHitHeadersKey = kit.curry(function (searchPath, source) { return kit.search(path.hitHeaders + "." + searchPath, source); });
/**
 ...
 * @returns {string}
 */
var getETag = kit.search(path.ETag);
/**
 ...
 * @returns {string}
 */
var getHitHost = kit.search(path.hitHost);
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.eventsource.responsecontent', eventType: 'com.adobe.eventtype.analytics', rootType: 'generic' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ requestEventId: 'abc-efg', hitUrl: 'ndh=1&c.&a.&AppID=TestApp-Swift&DayOfWeek=5', ETag: 'qwerty-asdfgh', hitHost: 'https://testorg.sc.omtrdc.net/b/ss/mobile5griffon.analytics.debug/0/OIP-2.3.0-2.7.1/s', eventSource: 'com.adobe.eventsource.responsecontent', eventType: 'com.adobe.eventtype.analytics', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: analyticsResponse_json_1["default"], get: get }, customExports), { getRequestEventId: getRequestEventId, getHitUrl: getHitUrl, getHitHeaders: getHitHeaders, getHitHeadersKey: getHitHeadersKey, getETag: getETag, getHitHost: getHitHost, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

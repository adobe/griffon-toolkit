...
var personalizationEdgeResponse_json_1 = __importDefault(require("../schemas/personalizationEdgeResponse.json"));
/**
 ...
 * @constant
 */
var RESPONSE_TYPE = 'personalization:decisions';
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ responseType: 'personalization:decisions', eventType: 'com.adobe.eventtype.edge', rootType: 'generic' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ responseType: 'personalization:decisions', requestId: 'BC123-8901-1234-AAFF-580993AC6258', requestEventId: 'abc-efg', eventSource: 'com.adobe.eventsource.responsecontent', eventType: 'com.adobe.eventtype.edge', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: personalizationEdgeResponse_json_1["default"], get: get }, customExports), { isMatch: isMatch, matcher: matcher, RESPONSE_TYPE: RESPONSE_TYPE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

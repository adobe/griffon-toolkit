...
import schema from '../schemas/targetMessagesResponse.json';

/**
 * Contains constants and functions for a Target Messages Response.
 *
 * The structure for a Target Messages Response is as follows:
 * ```
 * {
 *   payload: {
 ...
 * ```
 *
 * @namespace targetMessagesResponse
 */

/**
 * Paths for the keys on a Target Messages Response
 *
 * @enum {string}
 */
const path = {
 ...
 */
const uniqueName = 'targetMessagesResponse';
 ...
 */
const label = 'Target Messages Response';
...
/**
 * The value for `responseType` for a Target Messages Response.
 *
...
/**
 * The value for `eventType` for a Target Messages Response.
 *
...
/**
 * The value for `vendor` for a Target Messages Response.
 *
 * Path is `vendor`.
 *
 * @constant
...
/**
 * The value for `rootType` for a Target Messages Response.
 *
 * Path is `type`.
 *
 * @constant
...
/**
 * Matcher can be used to find matching Target Messages Response objects.
 *
 * @see kit.match
 * @constant
 */
const matcher = kit.combineAll([
  ...
  'vendor==`com.adobe.griffon.mobile`',
  'timestamp',
  'payload.ACPExtensionEventData.payload[0].scopeDetails.decisionProvider==`TGT`'
]);

/**
 * Tests the provided source against the matcher to see if it's Target Messages Response event.
 *
 * @function
 * @param {object} source The Target Messages Response instance
 * @returns {boolean}
 * @see kit.isMatch
 */
const isMatch = (source) => kit.isMatch(matcher, source);
/**
 * Generates a Target Messages Response with the const values set.
...
/**
 * Generates a Target Messages Response with some default values set.
 * Can be useful in testing.

...
import schema from '../schemas/setPushIdentifier.json';
 ...
 */
const uniqueName = 'setPushIdentifier';
 ...
 */
const label = 'Set Push Identifier';
 ...
 * @constant
 */
const EVENT_TYPE = 'com.adobe.eventType.generic.identity';
...
const make = (input) => kit.expandWithPaths(path, {
  ...
  eventType: 'com.adobe.eventType.generic.identity',
  rootType: 'generic',
  ...input
});

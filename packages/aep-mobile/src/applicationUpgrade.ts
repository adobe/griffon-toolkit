...
import schema from '../schemas/applicationUpgrade.json';
 ...
 */
const uniqueName = 'applicationUpgrade';
 ...
 */
const label = 'Application Upgrade';
 ...
 * @returns {string}
 */
const getUpgradeevent = kit.search(path.upgradeevent);

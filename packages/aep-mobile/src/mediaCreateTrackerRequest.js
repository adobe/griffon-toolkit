...
var mediaCreateTrackerRequest_json_1 = __importDefault(require("../schemas/mediaCreateTrackerRequest.json"));
/**
 ...
 */
var label = 'Media Create Tracker Request Event';
/**
 ...
 * @constant
 */
var EVENT_SOURCE = 'com.adobe.eventsource.media.requesttracker';
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.eventsource.media.requesttracker', eventType: 'com.adobe.eventtype.media', rootType: 'generic' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ trackerId: 'trackerId123', eventSource: 'com.adobe.eventsource.media.requesttracker', eventType: 'com.adobe.eventtype.media', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: mediaCreateTrackerRequest_json_1["default"], get: get }, customExports), { getTrackerId: getTrackerId, getEventParams: getEventParams, getEventParamsKey: getEventParamsKey, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

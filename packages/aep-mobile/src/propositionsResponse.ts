...
import schema from '../schemas/propositionsResponse.json';

/**
 * Contains constants and functions for a Messaging Propositions Response.
 *
 * The structure for a Messaging Propositions Response is as follows:
 * ```
 * {
 *   payload: {
 ...
 * ```
 *
 * @namespace propositionsResponse
 */

/**
 * Paths for the keys on a Messaging Propositions Response
 *
 * @enum {string}
 */
const path = {
  ...
  /** The list of surfaces propositions were requested for.<br />Path is `payload.ACPExtensionEventData.propositions`. */
 ...
 */
const uniqueName = 'propositionsResponse';
 ...
 */
const label = 'Messaging Propositions Response';
...
/**
 * The value for `eventSource` for a Messaging Propositions Response.
 *
...
/**
 * The value for `eventType` for a Messaging Propositions Response.
 *
...
/**
 * The value for `vendor` for a Messaging Propositions Response.
 *
 * Path is `vendor`.
 *
 * @constant
...
/**
 * The value for `rootType` for a Messaging Propositions Response.
 *
 * Path is `type`.
 *
 * @constant
...
/**
 * Returns the `propositions` from the Messaging Propositions Response.
 * This is the the list of surfaces propositions were requested for.
 *
 * Path is `payload,ACPExtensionEventData,propositions`.
 *
 * @function
 * @param {object} source The Messaging Propositions Response instance
 * @returns {Array}
 */
const getPropositions = kit.search(path.propositions);

/**
 * Matcher can be used to find matching Messaging Propositions Response objects.
 *
 * @see kit.match
 * @constant
 */
...
/**
 * Tests the provided source against the matcher to see if it's Messaging Propositions Response event.
 *
 * @function
 * @param {object} source The Messaging Propositions Response instance
 * @returns {boolean}
...
/**
 * Generates a Messaging Propositions Response with the const values set.
...
/**
 * Generates a Messaging Propositions Response with some default values set.
 * Can be useful in testing.

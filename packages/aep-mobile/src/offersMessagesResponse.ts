...
import schema from '../schemas/offersMessagesResponse.json';

/**
 * Contains constants and functions for a Offers Messages Response.
 *
 * The structure for a Offers Messages Response is as follows:
 * ```
 * {
 *   payload: {
 ...
 * ```
 *
 * @namespace offersMessagesResponse
 */

/**
 * Paths for the keys on a Offers Messages Response
 *
 * @enum {string}
 */
const path = {
...
/**
 * The value for `responseType` for a Offers Messages Response.
 *
...
/**
 * The value for `eventType` for a Offers Messages Response.
 *
...
/**
 * The value for `vendor` for a Offers Messages Response.
 *
 * Path is `vendor`.
 *
 * @constant
...
/**
 * The value for `rootType` for a Offers Messages Response.
 *
 * Path is `type`.
 *
 * @constant
...
/**
 * Matcher can be used to find matching Offers Messages Response objects.
 *
 * @see kit.match
 * @constant
 */
const matcher = kit.combineAll([
  ...
  'vendor==`com.adobe.griffon.mobile`',
  'timestamp',
  'payload.ACPExtensionEventData.payload[0].placement.id'
]);

/**
 * Tests the provided source against the matcher to see if it's Offers Messages Response event.
 *
 * @function
 * @param {object} source The Offers Messages Response instance
 * @returns {boolean}
 * @see kit.isMatch
 */
const isMatch = (source) => kit.isMatch(matcher, source);
/**
 * Generates a Offers Messages Response with the const values set.
...
/**
 * Generates a Offers Messages Response with some default values set.
 * Can be useful in testing.

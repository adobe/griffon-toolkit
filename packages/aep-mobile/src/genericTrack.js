...
var genericTrack_json_1 = __importDefault(require("../schemas/genericTrack.json"));
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ contextData: { 'myapp.purchase': '1' }, eventSource: 'com.adobe.eventsource.requestcontent', eventType: 'com.adobe.eventtype.generic.track', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: genericTrack_json_1["default"], get: get }, customExports), { getContextData: getContextData, getContextDataKey: getContextDataKey, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

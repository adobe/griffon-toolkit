...
var edgeErrorResponse_json_1 = __importDefault(require("../schemas/edgeErrorResponse.json"));
/**
 ...
 */
var label = 'AEP Edge Error Response';
/**
 ...
 * @constant
 */
var EVENT_SOURCE = 'com.adobe.eventsource.errorresponsecontent';
/**
 ...
 * @returns {Array}
 */
var getRequestPayload = kit.search(path.requestPayload);
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.eventsource.errorresponsecontent', eventType: 'com.adobe.eventtype.edge', rootType: 'generic' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ requestId: 'BC123-8901-1234-AAFF-580993AC6258', requestType: 'state:store', eventSource: 'com.adobe.eventsource.errorresponsecontent', eventType: 'com.adobe.eventtype.edge', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: edgeErrorResponse_json_1["default"], get: get }, customExports), { getRequestId: getRequestId, getRequestType: getRequestType, getRequestPayload: getRequestPayload, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

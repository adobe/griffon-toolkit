...
import schema from '../schemas/edgeBridgeRequest.json';

/**
 * Contains constants and functions for a AEP Edge Bridge Request.
 *
 * The structure for a AEP Edge Bridge Request is as follows:
 * ```
 * {
 *   payload: {
 ...
 * ```
 *
 * @namespace edgeBridgeRequest
 */

/**
 * Paths for the keys on a AEP Edge Bridge Request
 *
 * @enum {string}
 */
const path = {
  ...
  data: 'payload.ACPExtensionEventData.data',

  /** Context data sent with the track call.<br />Path is `payload.ACPExtensionEventData.data.contextdata`. */
  contextData: 'payload.ACPExtensionEventData.data.contextdata',
 ...
 */
const uniqueName = 'edgeBridgeRequest';
 ...
 */
const label = 'AEP Edge Bridge Request';
...
/**
 * The value for `eventSource` for a AEP Edge Bridge Request.
 *
...
/**
 * The value for `eventType` for a AEP Edge Bridge Request.
 *
...
/**
 * The value for `eventName` for a AEP Edge Bridge Request.
 *
 * Path is `payload,ACPExtensionEventName`.
 *
 * @constant
 */
const EVENT_NAME = 'Edge Bridge Request';

/**
 * The value for `rootType` for a AEP Edge Bridge Request.
 *
 * Path is `type`.
 *
 * @constant
...
/**
 * Returns the `contextData` from the AEP Edge Bridge Request.
 * This is the context data sent with the track call.
 *
 * Path is `payload,ACPExtensionEventData,data,contextdata`.
 *
 * @function
 * @param {object} source The AEP Edge Bridge Request instance
 * @returns {object}
 */
 ...
 * of the AEP Edge Bridge Request.
 *
 * @function
...
/**
 * Returns the `xdm` from the AEP Edge Bridge Request.
...
/**
 * Matcher can be used to find matching AEP Edge Bridge Request objects.
 *
 * @see kit.match
 * @constant
 */
...
/**
 * Tests the provided source against the matcher to see if it's AEP Edge Bridge Request event.
 *
 * @function
 * @param {object} source The AEP Edge Bridge Request instance
 * @returns {boolean}
...
/**
 * Generates a AEP Edge Bridge Request with the const values set.
...
const make = (input) => kit.expandWithPaths(path, {
  ...
  eventName: 'Edge Bridge Request',
  rootType: 'generic',
  ...input
});

/**
 * Generates a AEP Edge Bridge Request with some default values set.
 * Can be useful in testing.

...
var clientInfoIOS_json_1 = __importDefault(require("../schemas/clientInfoIOS.json"));
/**
 ...
 */
var label = 'iOS Client Info Event';
/**
 ...
 * @returns {string}
 */
var getModel = kit.search(path.model);
/**
 ...
 * @returns {string}
 */
var getBatteryState = kit.search(path.batteryState);
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ platform: 'iOS', type: 'connect', rootType: 'client' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ platform: 'iOS', deviceName: 'Testing iPhone', deviceType: 'iPhone/iPod touch', model: 'iPhone', os: 'iOS 13.5.1', screenSize: '1125x2436', batteryLevel: 94, batteryState: 'Battery Full', locationEnabled: true, locationAuth: 'Always', lowPowerMode: false, type: 'connect', rootType: 'client', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: clientInfoIOS_json_1["default"], get: get }, customExports), { getPlatform: getPlatform, getDeviceName: getDeviceName, getDeviceType: getDeviceType, getModel: getModel, getOs: getOs, getScreenSize: getScreenSize, getBatteryLevel: getBatteryLevel, getBatteryState: getBatteryState, getLocationEnabled: getLocationEnabled, getLocationAuth: getLocationAuth, getLowPowerMode: getLowPowerMode, isMatch: isMatch, matcher: matcher, PLATFORM: PLATFORM, TYPE: TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

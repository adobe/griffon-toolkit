...
var applicationLaunch_json_1 = __importDefault(require("../schemas/applicationLaunch.json"));
/**
 ...
 */
var label = 'Application Launch (Analytics)';
/**
...
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: applicationLaunch_json_1["default"], get: get }, customExports), { getData: getData, getDataKey: getDataKey, getLifecycleContextData: getLifecycleContextData, getLifecycleContextDataKey: getLifecycleContextDataKey, getLaunchEvent: getLaunchEvent, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

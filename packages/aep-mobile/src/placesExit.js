...
var placesExit_json_1 = __importDefault(require("../schemas/placesExit.json"));
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ regionEventType: 'exit', eventSource: 'com.adobe.eventsource.responsecontent', eventType: 'com.adobe.eventtype.places', rootType: 'generic' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ latitude: 40.4045982, libraryId: '04213', longitude: -111.8636017, name: 'Adobe', radius: 375, id: '31512', within: false, weight: 2, regionEventType: 'exit', eventSource: 'com.adobe.eventsource.responsecontent', eventType: 'com.adobe.eventtype.places', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: placesExit_json_1["default"], get: get }, customExports), { getData: getData, getDataKey: getDataKey, getPOI: getPOI, getRegionEventType: getRegionEventType, isMatch: isMatch, matcher: matcher, REGION_EVENT_TYPE: REGION_EVENT_TYPE, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

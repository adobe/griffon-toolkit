...
var optimizeNotification_json_1 = __importDefault(require("../schemas/optimizeNotification.json"));
/**
 ...
 */
var label = 'Notification From the Optimize Extension';
/**
 ...
 * @constant
 */
var EVENT_SOURCE = 'com.adobe.eventsource.notification';
/**
 ...
 * @constant
 */
var EVENT_TYPE = 'com.adobe.eventtype.optimize';
/**
 ...
 * @returns {Array}
 */
var getPropositions = kit.search(path.propositions);
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.eventsource.notification', eventType: 'com.adobe.eventtype.optimize', rootType: 'generic' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ propositions: [{ name: 'eyJ4ZG06YWN0aXZpdHlJZCI6Inhjb3JlOm9mZmVyLWFjdGl2aXR5OjEzNGNlY2MyMGU2NjljZWEiLCJ4ZG06cGxhY2VtZW50SWQiOiJ4Y29yZTpvZmZlci1wbGFjZW1lbnQ6MTJiOWE0MGVhNjkyOGJmOSJ9' }, { id: 'abcd', scope: 'eyJ4ZG06YWN0aXZpdHlJZCI6Inhjb3JlOm9mZmVyLWFjdGl2aXR5OjEzNGNlY2MyMGU2NjljZWEiLCJ4ZG06cGxhY2VtZW50SWQiOiJ4Y29yZTpvZmZlci1wbGFjZW1lbnQ6MTJiOWE0MGVhNjkyOGJmOSJ9' }], eventSource: 'com.adobe.eventsource.notification', eventType: 'com.adobe.eventtype.optimize', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: optimizeNotification_json_1["default"], get: get }, customExports), { getPropositions: getPropositions, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

...
var setPushIdentifier_json_1 = __importDefault(require("../schemas/setPushIdentifier.json"));
/**
 ...
 * @constant
 */
var EVENT_TYPE = 'com.adobe.eventtype.generic.identity';
/**
...
/**
 * Returns the `pushIdentifier` from the Set Push Identifier.
 * This is the the token used to send push messages.
 *
 * Path is `payload,ACPExtensionEventData,pushidentifier`.
 *
 * @function
 * @param {object} source The Set Push Identifier instance
 * @returns {string}
 */
...
/**
 * Generates a Set Push Identifier with the const values set.
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.eventsource.requestcontent', eventType: 'com.adobe.eventtype.generic.identity', rootType: 'generic' }, input)); };
/**
 * Generates a Set Push Identifier with some default values set.
 * Can be useful in testing.
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ pushIdentifier: 'asdfwerfasdfae-asdfasdfasdf', eventSource: 'com.adobe.eventsource.requestcontent', eventType: 'com.adobe.eventtype.generic.identity', rootType: 'generic', vendor: 'com.adobe.mobile.sdk', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: setPushIdentifier_json_1["default"], get: get }, customExports), { getPushIdentifier: getPushIdentifier, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, EVENT_TYPE: EVENT_TYPE, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

...
var screenshotCaptureCommand_json_1 = __importDefault(require("../schemas/screenshotCaptureCommand.json"));
/**
 ...
 */
var label = 'Screenshot Capture Command';
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ type: 'screenshot', vendor: 'com.adobe.griffon.mobile', rootType: 'control' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ type: 'screenshot', vendor: 'com.adobe.griffon.mobile', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootType: 'control' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: screenshotCaptureCommand_json_1["default"], get: get }, customExports), { getType: getType, isMatch: isMatch, matcher: matcher, TYPE: TYPE, VENDOR: VENDOR, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });

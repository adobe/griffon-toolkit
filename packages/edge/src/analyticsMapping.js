...
var analyticsMapping_json_1 = __importDefault(require("../schemas/analyticsMapping.json"));
/**
 ...
 * @returns {object}
 */
var make = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.analytics', name: 'analytics.mapping', rootType: 'service' }, input)); };
/**
 ...
 * @returns {object}
 */
var mock = function (input) { return kit.expandWithPaths(path, __assign({ eventSource: 'com.adobe.analytics', primaryHitId: '2FC717AB05158000-4023A7954DCA58D7', requestId: '93619B4C-D4EE-4BA9-BE3F-DD430A155013', name: 'analytics.mapping', rootType: 'service', clientId: 'appleABC', timestamp: Date.parse('12 Jan 2020 07:23:17 GMT'), rootId: '123' }, input)); };
/* ADD CUSTOM CONTENT BELOW */
// additional exports should be added here:
var customExports = {};
/* END CUSTOM CONTENT */
/* The content below is autogenerated. Do not make any changes */
exports["default"] = __assign(__assign({ path: path, mock: mock, make: make, schema: analyticsMapping_json_1["default"], get: get }, customExports), { getAttributes: getAttributes, getAttributesKey: getAttributesKey, isMatch: isMatch, matcher: matcher, EVENT_SOURCE: EVENT_SOURCE, NAME: NAME, ROOT_TYPE: ROOT_TYPE, label: label, group: group, parentDepth: parentDepth });
